      ...
      <header className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8 flex justify-between items-center">
          <div className="flex items-center">
            <img src="/placeholder.svg?height=40&width=40&text=Logo" alt="Logo du client" className="h-10 w-10 mr-3" />
            ...
            >
              <div className="bg-white shadow rounded-lg p-6">
                <div className="flex items-center justify-center mb-4">
                  <img
                    src="/placeholder.svg?height=160&width=160&text=Avatar"
              ...
              <div className="bg-white shadow rounded-lg p-6">
                ...
                <div className="relative">
                  <div className="aspect-w-16 aspect-h-9 mb-4" style={{height: "180px"}}>
                    <img
                      src={`/placeholder.svg?height=180&width=320&text=Vidéo+de+tâche+${currentVideoIndex + 1}`}
                ...
                <div className="h-64 overflow-y-auto p-4 space-y-4">
                  <div className="flex items-start">
                    <div className="flex-shrink-0">
                      <div className="relative">
                        <img className="h-10 w-10 rounded-full" src="/placeholder.svg?height=40&width=40" alt="Avatar CoGeo" />
